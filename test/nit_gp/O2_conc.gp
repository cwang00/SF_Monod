...
set title "O2, t = 1"
splot './more_particles/conc.1.00000001.gnuplot' using (1+$1):($2+1):3 index 27 matrix with image
pause -1 "O2, t = 1, Press enter to continue "

set title "O2, t = 2"
splot './more_particles/conc.1.00000002.gnuplot' using (1+$1):($2+1):3 index 27 matrix with image
pause -1 "O2, t = 2,Press enter to continue"

set title "O2, t = 3"
splot './more_particles/conc.1.00000003.gnuplot' using (1+$1):($2+1):3 index 27 matrix with image
pause -1 "O2, t = 3, Press enter to continue"

set title "O2, t = 4"
splot './more_particles/conc.1.00000004.gnuplot' using (1+$1):($2+1):3 index 27 matrix with image
pause -1 "O2, t = 4, Press enter to continue"

set title "O2, t = 5"
splot './more_particles/conc.1.00000005.gnuplot' using (1+$1):($2+1):3 index 27 matrix with image
pause -1 "O2, t = 5, Press enter to continue"

set title "O2, t = 6"
splot './more_particles/conc.1.00000006.gnuplot' using (1+$1):($2+1):3 index 27 matrix with image
pause -1 "O2, t = 6, Press enter to continue"

set title "O2, t = 7"
splot './more_particles/conc.1.00000007.gnuplot' using (1+$1):($2+1):3 index 27 matrix with image
pause -1 "O2, t = 7, Press enter to continue"

set title "O2, t = 8"
splot './more_particles/conc.1.00000008.gnuplot' using (1+$1):($2+1):3 index 27 matrix with image
pause -1 "O2, t = 8, Press enter to continue"

set title "O2, t = 9"
splot './more_particles/conc.1.00000009.gnuplot' using (1+$1):($2+1):3 index 27 matrix with image
pause -1 "O2, t = 9, Press enter to continue"

set title "O2, t = 10"
splot './more_particles/conc.1.00000010.gnuplot' using (1+$1):($2+1):3 index 27 matrix with image
